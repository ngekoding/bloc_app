class TrailerModel {
  ...
  TrailerModel({int id, List<_Results> results}) {
    this._id = id;
  ...
  set results(List<_Results> results) => _results = results;

  TrailerModel.fromJson(Map<String, dynamic> json) {
    _id = json['id'];
    if (json['results'] != null) {
      _results = new List<_Results>();
      json['results'].forEach((v) {
        _results.add(new _Results.fromJson(v));
      });
    }
  }
